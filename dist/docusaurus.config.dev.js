...
module.exports = {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: "Copyright \xA9 ".concat(new Date().getFullYear(), " Paranjay Bind, Shiv Mehra, Rishabh Dhanuka, Wadalka Rushikesh")
    }
  },
  presets: [['@docusaurus/preset-classic', {
    docs: {
      sidebarPath: require.resolve('./sidebars.js'),
      editUrl: 'https://github.com/devparanjay/time-thief-documentation/docs'
    },
    blog: {
      showReadingTime: true,
      editUrl: 'https://github.com/devparanjay/time-thief-documentation/blog'
    },
    theme: {
